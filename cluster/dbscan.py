...
# points = [[float(eachpoint.split(",")[0]), float(eachpoint.split(",")[1])] for eachpoint in open(r"E:\Users\Desktop\points.txt","r")]
points = np.random.rand(200, 10) * 10
...
pl.plot([eachpoint[0] for eachpoint in group1], [eachpoint[1] for eachpoint in group1], '*r')
pl.plot([eachpoint[0] for eachpoint in group2], [eachpoint[1] for eachpoint in group2], 'xy')
